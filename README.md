...
All modular TypeScript backend services should be placed in the `services/` directory, following project structure and PRD conventions. Each service should have its own subdirectory (e.g., `ocr/`, `validation/`, etc.).
